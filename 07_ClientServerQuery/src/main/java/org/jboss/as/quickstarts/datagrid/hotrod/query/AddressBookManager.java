...
public class AddressBookManager {
   ...
   private void queryPersonByName() {
      ...
      Query query = qf.from(Person.class)
            ...
            .build();
      System.out.println("queryPersonByName() query duration (millis) = " + (System.currentTimeMillis() - cTime));
   ...
   private void queryPersonByPhone() {
      ...
      Query query = qf.from(Person.class)
            ...
            .build();
      System.out.println("queryPersonByPhone() query duration (millis) = " + (System.currentTimeMillis() - cTime));
